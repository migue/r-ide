...
public class RConsolePreferencesPage extends PreferencePage implements
	...
	protected IPreferenceStore doGetPreferenceStore() {
		return RLaunchingPlugin.getDefault().getPreferenceStore();
	}
	...
	protected void initializeValues() {
		...
		newPrompt.setText(store.getString(RConsoleConstants.PREF_NEW_PROMPT));

		appendPrompt.setText(store
				.getString(RConsoleConstants.PREF_CONTINUE_PROMPT));
	}
	...
	public boolean performOk() {
		...
		store.setValue(RConsoleConstants.PREF_NEW_PROMPT, newPrompt.getText());
		store.setValue(RConsoleConstants.PREF_CONTINUE_PROMPT, appendPrompt
				.getText());
